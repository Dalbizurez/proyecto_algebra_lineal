...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_vector = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btn_vector.setObjectName("btn_vector")
        self.verticalLayout_2.addWidget(self.btn_vector)
        self.btn_vectores = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btn_vectores.setObjectName("btn_vectores")
        self.verticalLayout_2.addWidget(self.btn_vectores)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_vector.setText(_translate("MainWindow", "Calculo de vector"))
        self.btn_vectores.setText(_translate("MainWindow", "Operaciones entre vectores"))
